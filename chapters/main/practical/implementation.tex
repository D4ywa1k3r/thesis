...
\lstinputlisting[language=Python,caption={Python snippet - obtaining module}, captionpos=b,label={ch:practical_realization:implementation:obtain:code}]{chapters/main/practical/listings/code/garbage.py}
