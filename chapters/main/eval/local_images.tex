...
The images are created and handed over to the analyzis manager one after the other.
...
\lstinputlisting[caption={Result RSA keys analyse}, captionpos=b, label={ch:eval:local_images:rsa_second_result}]{chapters/main/eval/listings/result_rsa_second.txt}
...
\lstinputlisting[caption={Result AWS token analyse}, captionpos=b, label={ch:eval:local_images:aws_second_result}]{chapters/main/eval/listings/result_aws_second.txt}
