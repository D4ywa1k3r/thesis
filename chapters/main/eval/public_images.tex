...
Each cloud provider offers normally a private area to make images only accessible to sepcial users and groups. 
...
\graffito{Note: The SHA is calculated over every image-layer by a special combination of hash calculations. This defines an image explicitly and makes clear which image was used exactly.}
